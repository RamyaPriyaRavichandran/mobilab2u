...
function PageGradiant() {
  return (
    <>
      ...
      <div
        aria-hidden="true"
        className="absolute inset-x-0 top-[calc(100%-13rem)] -z-10 transform-gpu overflow-hidden blur-3xl sm:top-[calc(84%-30rem)]"
      >
        <div
          style={{
            clipPath:
