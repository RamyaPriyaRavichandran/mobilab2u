...
export default function SPDashboard() {
  ...
  return (
    <>
      {/* Hero Banner (responsive tweaks only) */}
      <div className="bg-[#FBE2E2] px-5 pt-5 pb-[65px] rounded-bl-[10px] md:rounded-bl-none rounded-br-[10px] md:rounded-br-[20px] border-t md:p-8 mb-10 lg:p-12">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-3 md:gap-8 max-w-[1300px] mx-auto">
          <div className="md:text-left flex-1 basis-auto min-w-0 md:basis-2/3">
            <h3 className="text-lg md:text-3xl lg:text-3xl xl:text-4xl 2xl:text-4xl leading-[1.1] font-normal text-black mb-2 md:mb-5 break-words">
              Hello
              <br />
              {user?.name}!
            </h3>
      ...
      <main className="bg-white px-6 py-14 lg:px-8">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
          <div className="text-center md:text-left space-y-6">
            ...
            <p className="text-sm md:text-base lg:text-lg leading-7 text-gray-600 max-w-xl mx-auto md:mx-0">
              Thank you for being the heart of our mission. Every visit you make, every sample you collect, and every
              patient you serve brings vital care directly to those who need it most. You aren&apos;t just on the move;
              you are the movement. Your dedication has infinite value, and we are committed to reward every part of it.
            </p>
          ...
          <div className="flex justify-center md:justify-end">
            <div
              className="overflow-hidden shadow-xl border bg-white rounded-2xl w-full max-w-[450px] h-[220px] md:h-[320px]"
              style={{
                width: '100%',
                maxWidth: '450px',
                height: '320px',
            ...
            >
              ...
              <div className="relative w-full h-full">
                <Image
                  src="/assets/images/register/service-provider.svg"
                  alt="Service Partner"
                  fill
                  ...
                  <div className="absolute right-[-24px] bottom-[-20px] md:right-[-40px] md:bottom-[-40px]">
                    <div className="w-[110px] h-[110px] md:w-[220px] md:h-[220px] lg:w-[260px] lg:h-[260px] relative rounded-full overflow-hidden">
                      <Image
                        ...
                        alt={offer.subtitle}
                        fill
                        sizes="(max-width: 640px) 300px, (max-width: 1024px) 300px, 260px"
                        className="object-cover"
                      />
                    </div>
                  </div>
      ...
      {/* Trust Indicators */}
      <div className="flex flex-row md:flex-row gap-6 md:gap-20 items-center px-5 justify-center md:justify-evenly mt-4 mb-[60px] lg:mt-10 lg:mb-20 max-w-[1300px] mx-auto">
        <div className="text-center max-w-fit">
          ...
          <p className="mt-4 font-medium text-sm md:text-base lg:text-md xl:text-lg text-center">
        ...
        <div className="text-center max-w-fit">
          <div className="w-[80px] h-[80px] md:w-[100px] md:h-[100px] relative mx-auto">
            <Image
              src="/assets/images/customer/privacy.svg"
              alt="Privacy"
              fill
              sizes="80px"
              style={{ objectFit: 'contain' }}
