...
export default function JohorHealthcare() {
  ...
  return (
    <main>
      ...
      <section className="bg-[#fef1e7] pt-8 pb-16 md:pt-[3rem] md:pb-[6rem]">
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="text-[20px] md:text-3xl font-bold text-black mb-2">
            Home Sample Collection & Online Medicine Delivery in Johor
          </h1>
          ...
          <ul className="flex justify-center gap-0 text-md text-black font-semibold mt-[24px]">
            ...
            <li className="text-gray-500">Johor</li>
          </ul>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
            <div data-aos="fade-right">
              <h2
                ...
                data-aos="fade-in"
              >
                Home <em className="text-red-600">Blood Collection</em> & Online Doctor Consultation in Johor
              </h2>
              <p className="text-[14px] sm:text-base text-gray-600 mb-[1.5rem] sm:mb-10 text-justify sm:text-left">
                For the residents of Johor, health management no longer has to be a stressful experience. MobiLab2u
                brings certified doctors, lab reports, and medication to your doorstep in the form of a single app.
                Whether it is an online doctor consultation or regular{' '}
                <Link
                ...
                , medicine delivery we ensure Johor people receive the best medical assistance they require without
                stepping out of their house.
              </p>
            </div>

            <div
              className="rounded-2xl overflow-hidden w-full h-[12rem] md:w-[30rem] sm:h-[20rem]"
              data-aos="fade-left"
            >
              <Image
                src="/assets/images/location/home-blood-collection-online-doctor-consultation-in-johor.webp"
                className="w-full h-full object-cover block"
                width={480}
                height={288}
                alt="Home blood collection & online doctor consultation services provided conveniently in Johor, Malaysia"
                title="Home Blood Collection & Online Doctor Consultation In Johor"
              />
            </div>
          </div>
        </div>
      ...
      {/* Why Johor Residents Need Section */}
      <section className="py-6 md:py-12">
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 items-center">
            <div>
              <h2
                className="text-[18px] sm:text-2xl lg:text-3xl xl:text-4xl text-center font-bold text-gray-900 sm:mb-8 mb-4 splt-txt"
                data-splitting
                data-aos="fade-in"
              >
                Why Do <em className="text-red-600"> Johor Residents </em>Need Home Healthcare Services?
              </h2>
            </div>
            ...
            <div className="flex flex-col items-start text-gray-700">
              <p className="text-[14px] sm:text-lg text-gray-600 mb-[0.8rem] sm:mb-10 text-justify sm:text-left">
                Life is hectic in Johor, and visiting clinics or pharmacies usually ends up wasting precious time. For
                older patients, the task is even more formidable. MobiLab2u is built to eliminate these obstacles. With{' '}
                <Link
                ...
                , home blood sample pickups, and home medicine deliveries, the people of Johor can simply take care of
                their health while we handle the rest.
              </p>
            </div>
          </div>
            ...
            <div className="relative w-full max-w-6xl h-[16rem] sm:h-[20rem] md:h-[22rem]">
              <div className="absolute left-1/4 top-1/2 transform -translate-x-1/2 -translate-y-1/2 w-32 h-32 sm:w-64 sm:h-64 md:w-[20rem] md:h-[20rem] rounded-full overflow-hidden shadow-md z-10">
                <Image
                  ...
                  title="Home Healthcare & Online Doctor Consultation In Johor"
                  alt="Comprehensive home healthcare services are provided to patients in Johor for their convenience."
                  width={320}
                  height={320}
              ...
              <div className="absolute left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 w-36 h-36 sm:w-72 sm:h-72 md:w-[22rem] md:h-[22rem] rounded-full overflow-hidden shadow-lg z-20">
                <Image
                  ...
                  title="Residents Access Home Healthcare Services In Johor"
                  alt="Johor residents that receive personalized home healthcare services for recovery, comfort, and care."
                  width={320}
                  height={320}
                  className="w-full h-full object-cover"
                />
              ...
              <div className="absolute right-1/4 top-1/2 transform translate-x-1/2 -translate-y-1/2 w-32 h-32 sm:w-64 sm:h-64 md:w-[20rem] md:h-[20rem] rounded-full overflow-hidden shadow-md z-10">
                <Image
                  ...
                  title="Key Benefits Of Home Healthcare Services In Johor"
                  alt="Home healthcare services that provide convenience, expert care, and support for patients in Johor."
                  width={320}
                  height={320}
                  className="w-full h-full object-cover"
                />
      ...
      <section className="py-2 md:py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2
            ...
            data-aos="fade-in"
          >
            Complete<em className="text-red-600"> Home Healthcare Services </em>At Your Fingertip In Johor
          </h2>
            ...
            <div className="bg-[#fef1e7] rounded-2xl shadow-sm p-[1.4rem] md:p-8 text-center transition">
              <div className="flex justify-center mb-3 sm:mb-6">
                <Image
                  ...
                  title="Online Doctor Teleconsultation Services At Home In Johor"
                  alt="Online Doctor Teleconsultation Services At Home In Johor"
                  width={144}
                  height={144}
                  className="w-36 h-36"
                />
              </div>
              <h4 className="text-[16px] sm:text-xl font-semibold text-gray-900 mb-3">Teleconsultation with Doctors</h4>
              <p className="text-[14px] sm:text-md text-gray-600 mb-6">
                Consult with experienced doctors online and receive professional medical guidance without queueing in
                busy clinics.
              </p>
            ...
            <div className="bg-[#fef1e7] rounded-2xl shadow-sm p-[1.4rem] md:p-8 text-center transition">
              <div className="flex justify-center mb-3 sm:mb-6">
                <Image
                  ...
                  alt="Home Blood Sample Collection Services In Johor, Malaysia"
                  title="Home Blood Sample Collection Services In Johor, Malaysia"
                  width={144}
                  height={144}
                  className="w-36 h-36"
                />
              </div>
              <h4 className="text-[16px] sm:text-xl font-semibold text-gray-900 mb-3">Home Blood Sample Collection</h4>
              <p className="text-[14px] sm:text-md text-gray-600 mb-6">
                If you require blood tests, our expert staff will take your blood samples at home with you comfortably
                and safely.
              </p>
              <div className="flex justify-center gap-4">
                <Link
            ...
            <div className="relative bg-[#fef1e7] rounded-2xl shadow-sm p-[1.4rem] md:p-8 text-center transition">
              ...
              <div className="flex justify-center mb-3 sm:mb-6">
                <Image
                  ...
                  alt="Fast Prescription Medicine Delivery Services In Johor"
                  title="Fast Prescription Medicine Delivery Services In Johor"
                  width={144}
                  height={144}
                  className="w-36 h-36"
                />
              ...
              <h4 className="text-[16px] sm:text-xl font-semibold text-gray-900 mb-3">Medicine Delivery</h4>
              <p className="text-[14px] sm:text-md text-gray-600 mb-6">
                Once your prescription has been prepared, medicines are speedily delivered to your home, eliminating the
                need for unnecessary pharmacy visits.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            <div className="lg:col-span-7 bg-[#fef1e7] rounded-2xl p-5 lg:p-10 h-full">
              <h3
                className="text-[18px] sm:text-2xl lg:text-3xl xl:text-4xl text-center lg:text-left font-bold text-gray-900 mb-12 splt-txt"
                data-splitting
                data-aos="fade-in"
              >
                Key Benefits of
                <em className="text-red-600"> Our At-Home Healthcare </em>
                Services in Johor
              </h3>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                <div className="flex flex-col items-start space-y-3">
                  <Image
                    ...
                    alt="Convenient At-home Healthcare Services For Johor Residents"
                    title="Convenient At-home Healthcare Services For Johor Residents"
                    width={64}
                    height={64}
                    className="w-16 h-16"
                  />
                  <h4 className="text-[16px] sm:text-lg font-semibold text-gray-900">Convenience at Your Fingertips</h4>
                  <p className="text-[14px] sm:text-md text-gray-600">Saves travel time and long waiting hours.</p>
                </div>

                <div className="flex flex-col items-start space-y-3">
                  <Image
                    src="/assets/images/svg/trust.svg"
                    alt="Trusted And Safe Home Healthcare Services In Johor"
                    title="Trusted And Safe Home Healthcare Services In Johor"
                    width={64}
                    height={64}
                    className="w-16 h-16"
                  />
                  <h4 className="text-[16px] sm:text-lg font-semibold text-gray-900">Care You Can Trust</h4>
                  <p className="text-[14px] sm:text-md text-gray-600">
                    Safe and reliable services for the elderly and families.
                  </p>
                </div>

                <div className="flex flex-col items-start space-y-3">
                  <Image
                    src="/assets/images/svg/health-care-access.svg"
                    alt="Quick Access To Doctors, Labs, And Medicines In Johor"
                    title="Quick Access To Doctors, Labs, And Medicines In Johor"
                    width={64}
                    height={64}
                    className="w-16 h-16"
                  />
                  <h4 className="text-[16px] sm:text-lg font-semibold text-gray-900">All-in-One Healthcare Access</h4>
                  <p className="text-[14px] sm:text-md text-gray-600">
                    Quick access to doctors, labs, and medicines in one app.
                  </p>
                </div>

                <div className="flex flex-col items-start space-y-3">
                  <Image
                    src="/assets/images/svg/johor-residenta.svg"
                    alt="Personalized At-home Healthcare Solutions In Johor"
                    title="Personalized At-home Healthcare Solutions In Johor"
                    width={64}
                    height={64}
                    className="w-16 h-16"
                  />
                  <h4 className="text-[16px] sm:text-lg font-semibold text-gray-900">
                    Personalized for Johor Residents
                  </h4>
                  <p className="text-[14px] sm:text-md text-gray-600">
                    Trusted healthcare experience designed for Johor
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-5 rounded-2xl overflow-hidden shadow-md">
              <Image
                src="/assets/images/location/johor-home-healthcare-advantages.webp"
                title="Key Benefits Of At-home Healthcare Services In Johor"
                alt="Explore the key benefits of at-home healthcare in Johor, providing convenience, safety, & expert care"
                width={501}
                height={611}
                className="w-full h-full object-cover"
              />
      ...
      <section className="bg-[#fef1e7] py-12">
        <div className="max-w-7xl mx-auto px-6">
          <h3
            ...
            data-aos="fade-in"
          >
            Why Trust <em className="text-red-600">MobiLab2u</em> for Home Healthcare Services in Johor?
          </h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6" data-aos="fade-up">
            <div className="bg-white p-6 sm:p-[2.5rem] rounded-2xl shadow-sm">
              <Image
                src="/assets/images/svg/complete-health-care.svg"
                alt="Complete At-home Healthcare Services Via One App In Johor"
                title="Complete At-home Healthcare Services Via One App In Johor"
                width={48}
                height={48}
            ...
            <div className="bg-white p-6 sm:p-[2.5rem] rounded-2xl shadow-sm">
              <Image
                ...
                alt="Home Healthcare Services at Comfort of Home in Johor"
                title="Home Healthcare Services at Comfort of Home in Johor"
                width={48}
                height={48}
                className="w-12 h-12 mb-[1.5rem] filter [filter:brightness(0)_saturate(100%)_invert(18%)_sepia(92%)_saturate(7452%)_hue-rotate(353deg)_brightness(98%)_contrast(112%)]"
              />
              <h4 className="text-[16px] sm:text-xl font-semibold text-black mb-2">Convenience for Johor Residents</h4>
              <p className="text-[14px] sm:text-base text-gray-600">
            ...
            <div className="bg-white p-6 sm:p-[2.5rem] rounded-2xl shadow-sm">
              <Image
                ...
                alt="Trusted Healthcare Professionals For Homecare In Johor"
                title="Trusted Healthcare Professionals For Homecare In Johor"
                width={48}
                height={48}
                className="w-12 h-12 mb-[1.5rem] filter [filter:brightness(0)_saturate(100%)_invert(18%)_sepia(92%)_saturate(7452%)_hue-rotate(353deg)_brightness(98%)_contrast(112%)]"
              />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          <div className="md:sticky md:top-[8rem] self-start">
            <h3
              ...
              data-aos="fade-in"
            >
              How MobiLab2u Home <em className="text-red-600">Healthcare Services Work</em> in Johor?
            </h3>

            <div className="mt-6 flex justify-center">
              <Image
                src="/assets/images/location/svg/mobilab2u-home-healthcare.svg"
                alt="Explore complete at-home healthcare services including consultations, tests, and medicine in Johor"
                title="Comprehensive At-home Healthcare Services In Johor"
                width={384}
                height={384}
          ...
          <div className="space-y-8 relative">
            ...
            <div className="sticky md:top-[8rem] p-4 sm:p-6 rounded-3xl shadow-md bg-[#fef1e7] flex flex-col md:flex-row items-center gap-4 sm:gap-6">
              <div className="flex-1 text-center md:text-left">
                ...
                <p className="text-gray-700 text-sm sm:text-base">Install the app and create your account.</p>
              </div>
              <div className="w-28 h-28 sm:w-32 sm:h-32 md:w-40 md:h-40 rounded-2xl overflow-hidden flex-shrink-0">
                <Image
                  ...
                  alt="Download And Register Our Home Healthcare App In Johor"
                  title="Download And Register Our Home Healthcare App In Johor"
                  width={160}
                  height={160}
                  className="w-full h-full object-cover"
                />
            ...
            <div className="sticky md:top-[8rem] p-4 sm:p-6 rounded-3xl shadow-md bg-[#fef1e7] flex flex-col md:flex-row items-center gap-4 sm:gap-6">
              <div className="flex-1 text-center md:text-left">
                ...
                <p className="text-gray-700 text-sm sm:text-base">Get instant medical advice online.</p>
              </div>
              <div className="w-28 h-28 sm:w-32 sm:h-32 md:w-40 md:h-40 rounded-2xl overflow-hidden flex-shrink-0">
                <Image
                  src="/assets/images/location/svg/consult-doctor.svg"
                  alt="Consult A Doctor Online At The Comfort Of Home In Johor"
                  title="Consult A Doctor Online At The Comfort Of Home In Johor"
                  width={160}
                  height={160}
                  className="w-full h-full object-cover"
                />
            ...
            <div className="sticky md:top-[8rem] p-4 sm:p-6 rounded-3xl shadow-md bg-[#fef1e7] flex flex-col md:flex-row items-center gap-4 sm:gap-6">
              <div className="flex-1 text-center md:text-left">
                <div className="mb-4 flex justify-center md:justify-start">
                  <div className="bg-white rounded-full p-3 inline-flex">
                    <Image src="/assets/images/svg/three.svg" alt="quote" width={32} height={32} className="w-8 h-8" />
                  </div>
                </div>
            ...
            <div className="sticky md:top-[8rem] p-4 sm:p-6 rounded-3xl shadow-md bg-[#fef1e7] flex flex-col md:flex-row items-center gap-4 sm:gap-6">
              <div className="flex-1 text-center md:text-left">
                <div className="mb-4 flex justify-center md:justify-start">
                  <div className="bg-white rounded-full p-3 inline-flex">
                    <Image src="/assets/images/svg/four.svg" alt="quote" width={32} height={32} className="w-8 h-8" />
                  </div>
                </div>
                <h4 className="text-lg sm:text-xl font-semibold mb-2">Get Results</h4>
                <p className="text-gray-700 text-sm sm:text-base">Lab reports are uploaded directly to the app.</p>
              </div>
              <div className="w-28 h-28 sm:w-32 sm:h-32 md:w-40 md:h-40 rounded-2xl overflow-hidden flex-shrink-0">
                <Image
                  src="/assets/images/location/svg/get-results.svg"
                  alt="Receive Lab Test Results Directly In Our Mobilab2u App"
                  title="Receive Lab Test Results Directly In Our Mobilab2u App"
                  width={160}
                  height={160}
                  className="w-full h-full object-cover"
                />
            ...
            <div className="sticky md:top-[8rem] p-4 sm:p-6 rounded-3xl shadow-md bg-[#fef1e7] flex flex-col md:flex-row items-center gap-4 sm:gap-6">
              <div className="flex-1 text-center md:text-left">
                <div className="mb-4 flex justify-center md:justify-start">
                  <div className="bg-white rounded-full p-3 inline-flex">
                    <Image src="/assets/images/svg/five.svg" alt="quote" width={32} height={32} className="w-8 h-8" />
                  </div>
                </div>
              ...
              <div className="w-28 h-28 sm:w-32 sm:h-32 md:w-40 md:h-40 rounded-2xl overflow-hidden flex-shrink-0">
                <Image
                  ...
                  alt="Order And Receive Prescribed Medicines At Home In Johor"
                  title="Order And Receive Prescribed Medicines At Home In Johor"
                  width={160}
                  height={160}
                  className="w-full h-full object-cover"
                />
            ...
            <div className="sticky md:top-[8rem] p-4 sm:p-6 rounded-3xl shadow-md bg-[#fef1e7] flex flex-col md:flex-row items-center gap-4 sm:gap-6">
              <div className="flex-1 text-center md:text-left">
                <div className="mb-4 flex justify-center md:justify-start">
                  <div className="bg-white rounded-full p-3 inline-flex">
                    <Image src="/assets/images/svg/six.svg" alt="quote" width={32} height={32} className="w-8 h-8" />
                  </div>
                </div>
                <h4 className="text-lg sm:text-xl font-semibold mb-2">Follow-Up Care</h4>
                <p className="text-gray-700 text-sm sm:text-base">Schedule follow-up consultations as needed.</p>
              </div>
              <div className="w-28 h-28 sm:w-32 sm:h-32 md:w-40 md:h-40 rounded-2xl overflow-hidden flex-shrink-0">
                <Image
                  src="/assets/images/location/svg/follow-up-care.svg"
                  alt="Schedule Follow-up Care And Consultations At Home In Johor"
                  title="Schedule Follow-up Care And Consultations At Home In Johor"
                  width={160}
                  height={160}
                  className="w-full h-full object-cover"
                />
      ...
      <section className="bg-[#fef1e7] py-8 md:py-16 px-6 md:px-10 rounded-2xl text-center max-w-7xl mx-auto">
        <div className="max-w-5xl mx-auto" data-aos="fade-up">
          <h3
            ...
            data-aos="fade-in"
          >
            Book Your At-home<em className="text-red-600"> Healthcare Services</em> in Johor with MobiLab2u
          </h3>
          <p className="text-sm md:text-lg text-gray-600 mb-5 sm:mb-10">
            Your health deserves convenience and care. Download MobiLab2u or book online today to access{' '}
            <Link href="/services/tele-consultation" className="text-red-600" title="Tele Consultation">
              teleconsultations
            </Link>
            , home lab tests, and{' '}
            <Link href="/services" className="text-red-600" title="Prescription Medication Delivery">
      ...
      <section className="max-w-7xl mx-auto px-4 py-8 sm:py-16">
        <div className="w-full text-center">
          ...
          <h3
            ...
            data-aos="fade-in"
          >
            FAQs About MobiLab2u <em className="text-red-600"> Home Healthcare Services in </em> Johor
          </h3>
        </div>
          ...
          <div className="col-span-12 space-y-6">
            ...
            <div className="border rounded-lg shadow-sm p-4 sm:p-6">
              <div className="flex justify-between items-center cursor-pointer" onClick={() => toggleFaq(0)}>
                <h4 className="text-[16px] sm:text-lg font-semibold">
                  What are the services provided by MobiLab2u in Johor?
                </h4>
                <span className="text-gray-500 text-xl">{openFaqIndex === 0 ? '✖' : '＋'}</span>
              </div>
              {openFaqIndex === 0 && (
                <div className="mt-4 text-[14px] sm:text-[15px] text-gray-700">
                  MobiLab2u offers three primary services: doctor teleconsultation, home{' '}
                  <Link
                    href="/services/home-blood-sample-collection"
                    className="text-red-600"
                    title="Home Blood Sample Collection"
            ...
            <div className="border rounded-lg shadow-sm p-4 sm:p-6">
              <div className="flex justify-between items-center cursor-pointer" onClick={() => toggleFaq(1)}>
                <h4 className="text-[16px] sm:text-lg font-semibold">How can I begin utilizing MobiLab2u in Johor?</h4>
                <span className="text-gray-500 text-xl">{openFaqIndex === 1 ? '✖' : '＋'}</span>
              </div>
              {openFaqIndex === 1 && (
                <div className="mt-4 text-[14px] sm:text-[15px] text-gray-700">
                  <p>
                    Just download the MobiLab2u app, sign up with your Johor address, and select the service you
                    require.
                  </p>
                </div>
              )}
            ...
            <div className="border rounded-lg shadow-sm p-4 sm:p-6">
              <div className="flex justify-between items-center cursor-pointer" onClick={() => toggleFaq(2)}>
                <h4 className="text-[16px] sm:text-lg font-semibold">
                  Can I have blood tests conducted at home in Johor?
                </h4>
                <span className="text-gray-500 text-xl">{openFaqIndex === 2 ? '✖' : '＋'}</span>
              </div>
              {openFaqIndex === 2 && (
                <div className="mt-4 text-[14px] sm:text-[15px] text-gray-700">
                  Yes, our experienced professional collects blood samples from your home in Johor at your preferred
                  time slot.
                </div>
              )}
            </div>
            ...
            <div className="border rounded-lg shadow-sm p-4 sm:p-6">
              <div className="flex justify-between items-center cursor-pointer" onClick={() => toggleFaq(3)}>
                <h4 className="text-[16px] sm:text-lg font-semibold">How will I get my test results?</h4>
                <span className="text-gray-500 text-xl">{openFaqIndex === 3 ? '✖' : '＋'}</span>
              </div>
              {openFaqIndex === 3 && (
                <div className="mt-4 text-[14px] sm:text-[15px] text-gray-700">
                  Your lab reports will be uploaded onto the MobiLab2u app in digital form, which you may share with
            ...
            <div className="border rounded-lg shadow-sm p-4 sm:p-6">
              <div className="flex justify-between items-center cursor-pointer" onClick={() => toggleFaq(4)}>
                <h4 className="text-[16px] sm:text-lg font-semibold">
                  Is medicine delivery available throughout Johor?
                </h4>
                <span className="text-gray-500 text-xl">{openFaqIndex === 4 ? '✖' : '＋'}</span>
              </div>
              {openFaqIndex === 4 && (
                <div className="mt-4 text-[14px] sm:text-[15px] text-gray-700">
                  Yes, medicines are delivered to all the major neighborhoods and localities in Johor by our partner
                  pharmacies.
                </div>
              )}
            </div>
            ...
            <div className="border rounded-lg shadow-sm p-4 sm:p-6">
              <div className="flex justify-between items-center cursor-pointer" onClick={() => toggleFaq(5)}>
                <h4 className="text-[16px] sm:text-lg font-semibold">Who can gain the most from Mobilabu in Johor?</h4>
                <span className="text-gray-500 text-xl">{openFaqIndex === 5 ? '✖' : '＋'}</span>
              </div>
              {openFaqIndex === 5 && (
                <div className="mt-4 text-[14px] sm:text-[15px] text-gray-700">
                  Senior citizens, working professionals, and families who need quick access to doctors, laboratory
                  tests, and medications without the need for travel.
                </div>
              )}
            </div>
            ...
            <div className="border rounded-lg shadow-sm p-4 sm:p-6">
              <div className="flex justify-between items-center cursor-pointer" onClick={() => toggleFaq(6)}>
                <h4 className="text-[16px] sm:text-lg font-semibold">Is MobiLab2u safe and reliable?</h4>
                <span className="text-gray-500 text-xl">{openFaqIndex === 6 ? '✖' : '＋'}</span>
              </div>
              {openFaqIndex === 6 && (
                <div className="mt-4 text-[14px] sm:text-[15px] text-gray-700">
                  Absolutely. We work with qualified, accredited, and certified physicians, certified laboratories, and
                  reliable pharmacies to provide safe, secure, and reliable healthcare.
                </div>
              )}
            </div>
          </div>
