// Animation initialization utilities for Next.js
...
export function initSwiper() {
  ...
  script.onload = () => {
    ...
    new window.Swiper('.mySwiper', {
      ...
      pagination: {
        ...
        renderBullet: (index: number, className: string) =>
          `<span class="${className} bg-red-600 w-10 h-2 rounded-xl"></span>`,
      },
      breakpoints: {
        0: {
          slidesPerView: 1,
    ...
    // Initialize breadcrumb swiper
    new window.Swiper('.breadcrumbswiper', {
      slidesPerView: 5,
      spaceBetween: 0,
      loop: true,
      pagination: {
