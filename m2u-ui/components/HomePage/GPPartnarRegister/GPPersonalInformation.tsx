...
import type { GPPersonalInformationProps } from './GPAuthenticationInterface'
import StyledInput, {
  UserIcon,
  PhoneIcon,
  EmailIcon,
...
import { gender, gp_qualification, language } from '@/utils/constents'
...
export default function GPPersonalInformation({
  values,
  setFieldValue,
  handleSendOtp,
  verifyClicked,
  ...
  return (
    <>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        ...
        <StyledSelect name="medicalQualification" options={gp_qualification} icon={<MedicalIcon />} />
      </div>
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        <StyledInput name="registerNumber" placeholder="Register Number" icon={<UserIcon />} />
        <StyledSelect name="language" options={language || []} icon={<UserIcon />} />
      </div>
      {/* ID Proof Section */}
      <div>
